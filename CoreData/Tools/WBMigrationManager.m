...
@implementation WBMigrationManager
                          ...
                          error:(NSError **)error
{
    ...
    NSObject<WBMigrationManagerDelegate> *mappingDelegate = [self delegate];
    if ([mappingDelegate respondsToSelector:@selector(migrationManager:mappingModelForSourceModel:)]) {
        
        NSArray *explicitMappingModels = [mappingDelegate migrationManager:self mappingModelForSourceModel:sourceModel];
